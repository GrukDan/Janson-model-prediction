package client.GUI.liquidityRatios.coefficients.refinedLiquidityRatio;
...
public class RefinedLiquidityRatio implements Initializable {
            ...
            if (finishDate == null) {
                ...
                if (finishDate.getTime() < startDate.getTime()) {
                    ...
                    if (!periodField.getText().equals("")) {
                        ...
                        result.setCoefficient("Уточнённый коэффициент ликвидности");
