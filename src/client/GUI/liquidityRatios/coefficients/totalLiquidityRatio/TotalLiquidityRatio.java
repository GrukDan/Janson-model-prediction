package client.GUI.liquidityRatios.coefficients.totalLiquidityRatio;
...
public class TotalLiquidityRatio implements Initializable {
            ...
            if (finishDate == null) {
                ...
                if (finishDate.getTime() < startDate.getTime()) {
                    ...
                    if (!periodField.getText().equals("")) {
                        ...
                        result.setCoefficient("Общий коэффициент ликвидности");
